...
;;       doom-variable-pitch-font (font-spec :family "Consolas" :size 20)
;;       doom-unicode-font (font-spec :family "Consolas")
;;       doom-serif-font (font-spec :family "Consolas" :weight 'light))

;; (setq doom-font (font-spec :family "Cascadia Code" :size 20)
;;       doom-big-font (font-spec :family "Cascadia Code" :size 30)
;;       doom-variable-pitch-font (font-spec :family "Cascadia Code" :size 20)
;;       doom-unicode-font (font-spec :family "Cascadia Code")
;;       doom-serif-font (font-spec :family "Cascadia Code" :weight 'light))
